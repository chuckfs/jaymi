...
impl ParserRegistry {
    ...
    pub fn detect_type(path: &Path) -> Option<FileType> {
        ...
        match ext.as_str() {
            ...
            "txt" | "rs" | "toml" | "yaml" | "yml" | "jsonc" | "lock" | "js" | "jsx" | "ts"
            | "tsx" | "mjs" | "cjs" | "css" | "scss" | "less" | "html" | "htm" | "xml" | "svg"
            | "py" | "rb" | "go" | "java" | "kt" | "kts" | "c" | "h" | "cc" | "cpp" | "cxx"
            | "hpp" | "hxx" | "cs" | "swift" | "sh" | "bash" | "zsh" | "fish" | "ps1" | "sql"
            | "graphql" | "gql" | "proto" | "env" | "ini" | "cfg" | "conf" | "properties"
            | "gitignore" | "dockerignore" | "editorconfig" | "csv" | "tsv" | "log" | "ron"
            | "nix" | "gradle" | "cmake" | "mk" | "r" | "php" | "lua" | "vue" | "svelte"
